...
def equations_of_motion(params, particle_type='electron'):
    """
    PURPOSE:
    --------
    ...
    -------
        result: 3D array
            3D array list of particle's positions, velocities, and length of grid
    """
    v_init, p_init, B_field = params
    ...
    result = np.array([particle_velocity, particle_position, length_of_grid])
    return result 
...
def run_particles(num_samples, B_field):
    ...
    --------
        result: 3D array
            3D array list of each particle's positions, velocities, and length of grid
    """
    ...
    result = p.map(equations_of_motion, params)
    return result
